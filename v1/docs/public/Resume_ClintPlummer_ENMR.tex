...
\begin{cvsect}{Experience}
  ...
  \begin{entrylist}
    ...
    \par\medskip Joined the program to explore starting my own startup, learnt many valuable skills along the way from ideation,
    taking concepts to market (0 to 1), market validation, business models, product/market fit to capital raising/pitching
      }
    \entry
